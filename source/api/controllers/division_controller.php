...
*/
    public function getDivisionDataPerPeriod($id, $filters) {
        
                if (array_key_exists('periodId', $filters)) {
                    ...
                    return $this->model->getDivisionDataPerPeriod($id, $periodId);
